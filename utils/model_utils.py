...
def read_data(dataset):
    train_data_dir = os.path.join('data', dataset, 'train')  # 'train'    'data','train'
    test_data_dir = os.path.join('data', dataset, 'test')  # 'test'       'data','test'
    ...
    train_files = [f for f in train_files if f.endswith(".json")] # cifar_train.json
